...
const columns = [
  ...
  {
    dataField: 'fabric_type',
    text: 'Fabric Type',
    sort: true,
  },
  {
    dataField: 'yarn_count',
    text: 'Yarn Count',
    sort: true,
  },
  {
    dataField: 'fabric_color',
    text: 'Color',
    sort: true,
  },
  {
  ...
  {
    dataField: 'fabric_weight',
    text: 'Weight',
    sort: true,
  },
  {
    dataField: 'fabric_unit_price',
    text: 'Unit Price',
    sort: true,
  },
  {
...
export default class StockFabric extends Component {
  constructor(props) {
    super(props);
    this.state = { data: [] };
  }
  componentDidMount() {
    fetch('http://localhost/crovex/Crovex/HTML/dashboard/data1.php')
      .then(res => res.json())
      .then(data => {
        // console.log(data);
