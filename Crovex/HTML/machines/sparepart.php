        ...
        <div class="left-sidenav">
            <ul class="metismenu left-sidenav-menu">
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        <li class="nav-item"><a class="nav-link" href="../storage/stock-yarn.html"><i class="ti-control-record"></i>Stock Yarn</a></li>
                        <li class="nav-item"><a class="nav-link" href="../storage/stock-fabric.html"><i class="ti-control-record"></i>Stock Fabric</a></li>
                        <li class="nav-item"><a class="nav-link" href="../storage/stock-order.html"><i class="ti-control-record"></i>Orders</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="nav-second-level" aria-expanded="false">
                        <li class="nav-item"><a class="nav-link" href="../machines/machines.html"><i class="ti-control-record"></i>Machines</a></li>
                        <li class="nav-item"><a class="nav-link" href="../machines/sparepart.html"><i class="ti-control-record"></i>Sparepart</a></li>
                    </ul>
                </li>
