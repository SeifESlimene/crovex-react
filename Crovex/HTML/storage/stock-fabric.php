  ...
  <!--<div class="modal-dialog modal-lg">-->
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Add New Fabric to Stock</h5>
        ...
        <div class="modal-body">
            ...
            <!--Form-->
            <form action="fabricinsertcode.php" method="POST">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                <input type="date" name="cut_date" class="form-control" placeholder="Date">
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                <input type="text" name="fabric_weight" class="form-control" placeholder="Weight">
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                <input type="number" name="fabric_unit_price" class="form-control" placeholder="Unit Price">
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                <input type="number" name="machine" class="form-control" placeholder="Machine#">
                </div>
              </div>
              ...
              <div class="col-md-6">
                <div class="form-group">
                <input type="number" name="gauge" class="form-control" placeholder="gauge">
                </div>
              </div>
            </div>
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <!--<div class="modal-dialog modal-lg">-->
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Edit Fabric Stock</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        <div class="modal-body">
            ...
            <!--Form-->
            <form action="fabricupdatecode.php" method="POST">
            ...
            <div class="row">
              <div class="col-md-6">
                ...
                <input type="text" name="yarn_count" id= "yarn_count" class="form-control" placeholder="Yarn Count">
                </div>
              </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                <label for="cut_date">Date</label>
                <input type="text" name="cut_date" id= "cut_date" class="form-control" placeholder="Date">
                </div>
              </div>
              
              <div class="col-md-6">
                <div class="form-group">
                <label for="yarn_lot">LOT#</label>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                <label for="fabric_weight">Weight</label>
              ...
              <div class="col-md-6">
                <div class="form-group">
                <label for="fabric_unit_price">Unit Price</label>
                <input type="text" name="fabric_unit_price" id= "fabric_unit_price" class="form-control" placeholder="Unit Price">
                </div>
              </div>
            </div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <!--Form-->
            <form action="fabricdeletecode.php" method="POST">
            <div class="modal-body">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <h4 class="mt-0 header-title">Fabric List</h4>
                            <p class="text-muted mb-2">
                            </p>
<!--  ============================================================================================      Table       ==========================================================================  -->
            ...
            <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                ...
                <?php
                    ...
                    $query = "SELECT * FROM stock_fabric";
                ...
                <tr>
                  ...
                  <td> <?php echo $row['cut_date']; ?></td>
                  <td> <?php echo $row['yarn_lot']; ?></td>
                  <td> <?php echo $row['fabric_weight']; ?></td>
                  <td> <?php echo $row['fabric_unit_price']; ?></td>
...
<script>
    $(document).ready(function(){
        $('.editbtn').on('click', function(){
            ...
            $('#customer').val(data[1]);
            $('#fabric_type').val(data[2]);
            $('#yarn_count').val(data[3]);
            $('#fabric_color').val(data[4]);
            $('#cut_date').val(data[5]);
            $('#yarn_lot').val(data[6]);
            $('#fabric_weight').val(data[7]);
            $('#fabric_unit_price').val(data[8]);
            $('#machine').val(data[9]);
            $('#gauge').val(data[10]);
