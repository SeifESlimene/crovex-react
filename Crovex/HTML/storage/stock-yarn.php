    ...
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add New Yarn to Stock</h5>
            ...
            <div class="modal-body">
                ...
                <!--Form-->
                <form action="yarninsertcode.php" method="POST">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" name="yarn_type" class="form-control" placeholder="Yarn Type">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" name="yarn_count" class="form-control" placeholder="yarn count">
                                </div>
                            </div>

                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" name="yarn_color" class="form-control" placeholder="Color">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="date" name="delivery_date" class="form-control" placeholder="Date">
                                </div>
                            </div>

                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" name="yarn_lot" class="form-control" placeholder="LOT#">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="number" name="yarn_weight" class="form-control" placeholder="Weight">
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="number" name="yarn_unit_price" class="form-control"
...
<div class="modal fade" id="editmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit New Yarn to Stock</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <!--Form-->
                <form action="yarnupdatecode.php" method="POST">
                    <div class="modal-body">
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" value="fuck you bitch" class="form-control"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="yarn_type" id="yarn_type" class="form-control"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="yarn_count" id="yarn_count" class="form-control"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="yarn_color" id="yarn_color" class="form-control"
                                            placeholder="Color">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="yarn_lot" id="yarn_lot" class="form-control"
                                            placeholder="LOT#">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="yarn_weight" id="yarn_weight" class="form-control"
                                            placeholder="Weight">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" name="yarn_unit_price" id="yarn_unit_price"
...
<div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Delete Yarn</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                ...
                <!--Form-->
                <form action="yarndeletecode.php" method="POST">
                    <div class="modal-body">
...
<body>
    ...
    <div class="left-sidenav">
        <ul class="metismenu left-sidenav-menu">
            ...
            <li>
                <a href="javascript: void(0);"><i class="mdi mdi-account"></i><span>Profiles</span><span
                        class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                <ul class="nav-second-level" aria-expanded="false">
                    <li class="nav-item"><a class="nav-link" href="../profiles/profile-contact.html"><i
                                class="ti-control-record"></i>Contact</a></li>
                    <li class="nav-item"><a class="nav-link" href="../profiles/profile-employee.html"><i
                                class="ti-control-record"></i>Employees</a></li>
                    <li class="nav-item"><a class="nav-link" href="../profiles/profile-customer.html"><i
                                class="ti-control-record"></i>Customers</a></li>
                </ul>
            </li>

            <li>
                <a href="javascript: void(0);"><i class="fas fa-shopping-basket"></i><span>Product</span><span
                        class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                <ul class="nav-second-level" aria-expanded="false">
                    <li class="nav-item"><a class="nav-link" href="../product/ecommerce-products.html"><i
                                class="ti-control-record"></i>Product</a></li>
                    <li class="nav-item"><a class="nav-link" href="../product/ecommerce-product-list.html"><i
                                class="ti-control-record"></i>Product List</a></li>
                    <li class="nav-item"><a class="nav-link" href="../product/ecommerce-product-detail.html"><i
                                class="ti-control-record"></i>Product Detail</a></li>
                    <li class="nav-item"><a class="nav-link" href="../product/ecommerce-cart.html"><i
                                class="ti-control-record"></i>Cart</a></li>
                    <li class="nav-item"><a class="nav-link" href="../product/ecommerce-checkout.html"><i
                                class="ti-control-record"></i>Checkout</a></li>
                </ul>
            </li>

            <li>
                <a href="javascript: void(0);"><i class="mdi mdi-view-grid"></i><span>Storage</span><span
                        class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                <ul class="nav-second-level" aria-expanded="false">
            ...
            <li>
                <a href="javascript: void(0);"><i class="mdi mdi-factory"></i><span>Machines</span><span
                        class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                <ul class="nav-second-level" aria-expanded="false">
                    <li class="nav-item"><a class="nav-link" href="../machines/machines.php"><i
                                class="ti-control-record"></i>Machines</a></li>
                    <li class="nav-item"><a class="nav-link" href="../machines/sparepart.php"><i
                                class="ti-control-record"></i>Sparepart</a></li>
                </ul>
            </li>

            <li>
                <a href="javascript: void(0);"><i class="mdi mdi-settings"></i><span>Settings</span><span
                        class="menu-arrow"><i class="mdi mdi-chevron-right"></i></span></a>
                <ul class="nav-second-level" aria-expanded="false">
                    <li class="nav-item"><a class="nav-link" href="../settings/settings-setting.html"><i
                        ...
                        <div class="page-title-box">
                            <div class="float-right">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">Yarn List                                         <?php
$htmlCode = '<td>
        <a href="#!" class="editbtn" data-toggle="tooltip"
        ...
        <a href="#!" class="deletebtn" data-toggle="tooltip"
...
$query1     = "INSERT INTO stock_yarn (`action`) VALUES ('$htmlCode')";
...
?> </li>
                    ...
                    <div class="col-12">
                        <div class="card table-responsive py-">
                            <div class="card-body">
                                ...
                                <h4 class="ses3 mt-0 header-title">Yarn List</h4>
                                <a href="#" class="btn btn-primary ses3" data-toggle="modal"
    ...
    <!-- <div>
        <?php $query = "SELECT * FROM stock_yarn";
$query_run           = mysqli_query($connection, $query);
if ($query_run) {
	foreach ($query_run as $row) {

		var_dump(trim($row['customer']));
	}
...
?>
    ...
    $(document).ready(function() {
        $('.editbtn').on('click', function() {
            ...
            $('#customer').val(data[1].trim());
            $('#yarn_type').val(data[2].trim());
            $('#yarn_count').val(data[3].trim());
            $('#yarn_color').val(data[4].trim());
            $('#delivery_date').val(data[5].trim());
            $('#yarn_lot').val(data[6].trim());
            $('#yarn_weight').val(data[7].trim());
            $('#yarn_unit_price').val(data[8].trim());
